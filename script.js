...
tulis = document.getElementById("tulis"),
...
window.addEventListener("load", () => {  
    ...
    canvas.height = 3000 //canvas.offsetHeight - 7;
    ctx.lineCap = "round";
    setCanvasBackground();
});
...
//hps.addEventListener("click", () => brushSize =30);
hps.onclick=function(){brushSize =20;selectedColor='#fff';selectedTool='brush'}
tulis.onclick=function(){brushSize =2;selectedColor='#000';selectedTool='brush'}
